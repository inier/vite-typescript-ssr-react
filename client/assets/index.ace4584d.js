import {R as React, r as react, a as ReactDOM, B as BrowserRouter} from "./vendor.7f7f4ee8.js";
const Footer = () => {
  return /* @__PURE__ */ React.createElement("footer", {
    className: "justify-center items-center"
  }, "\xA9 ", new Date().getFullYear(), " - ", /* @__PURE__ */ React.createElement("a", {
    href: "https://jonlu.ca"
  }, "JonLuca DeCaro"), " -", " ", /* @__PURE__ */ React.createElement("a", {
    className: "p-1",
...
const Main = () => {
  ...
  }, "Hi", name ? `, ${name}!` : ""), /* @__PURE__ */ React.createElement("h2", {
    className: "w-2/5 p-5 items-center flex align-middle text-center min-w-[320px]",
    style: {color: "green"}
  }, "This is a Vite React SSR Tailwind boilerplate! This is new text!!"), /* @__PURE__ */ React.createElement("input", {
...
const App = () => {
  return /* @__PURE__ */ React.createElement(ContextWrapper, null, /* @__PURE__ */ React.createElement(Main, null));
};
var index = `/*! tailwindcss v2.1.2 | MIT License | https://tailwindcss.com *//*! modern-normalize v1.1.0 | MIT License | https://github.com/sindresorhus/modern-normalize */
